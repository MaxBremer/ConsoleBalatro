...
namespace ConsoleBalatro.Engine.Cards.Jokers
{
    public static class JokerDb
    {
        ...
        public static Dictionary<string, JokerTypeData> JokerMetadata = new()
        {
            ...
            {"GOLDEN TICKET", new JokerTypeData { DBName = "GOLDEN TICKET", Price = 5, AchievementForUnlock = AchievementDb.GoldenTicket_UnlockId } },
            {"MR. BONES", new JokerTypeData { DBName = "MR. BONES", Price = 5, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.MrBones_UnlockId } },
            {"ACROBAT", new JokerTypeData { DBName = "ACROBAT", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Acrobat_UnlockId } },
            {"SOCK AND BUSKIN", new JokerTypeData { DBName = "SOCK AND BUSKIN", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.SockAndBuskin_UnlockId } },
            {"SWASHBUCKLER", new JokerTypeData { DBName = "SWASHBUCKLER", Price = 4, AchievementForUnlock = AchievementDb.Swashbuckler_UnlockId } },
            {"TROUBADOUR", new JokerTypeData { DBName = "TROUBADOUR", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Troubadour_UnlockId } },
            {"CERTIFICATE", new JokerTypeData { DBName = "CERTIFICATE", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Certificate_UnlockId } },
            {"SMEARED JOKER", new JokerTypeData { DBName = "SMEARED JOKER", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.SmearedJoker_UnlockId } },
            {"THROWBACK", new JokerTypeData { DBName = "THROWBACK", Price = 6, Rarity = JokerRarity.UNCOMMON } },
            {"HANGING CHAD", new JokerTypeData { DBName = "HANGING CHAD", Price = 4, AchievementForUnlock = AchievementDb.HangingChad_UnlockId } },
            {"ROUGH GEM", new JokerTypeData { DBName = "ROUGH GEM", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.RoughGem_UnlockId } },
            {"BLOODSTONE", new JokerTypeData { DBName = "BLOODSTONE", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.BloodStone_UnlockId } },
            {"ARROWHEAD", new JokerTypeData { DBName = "ARROWHEAD", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Arrowhead_UnlockId } },
            {"ONYX AGATE", new JokerTypeData { DBName = "ONYX AGATE", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.OnyxAgate_UnlockId } },
            {"GLASS JOKER", new JokerTypeData { DBName = "GLASS JOKER", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.GlassJoker_UnlockId } },
            {"SHOWMAN", new JokerTypeData { DBName = "SHOWMAN", Price = 5, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Showman_UnlockId } },
            {"FLOWER POT", new JokerTypeData { DBName = "FLOWER POT", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Flowerpot_UnlockId } },
            {"BLUEPRINT", new JokerTypeData { DBName = "BLUEPRINT", Price = 10, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Blueprint_UnlockId } },
            {"WEE JOKER", new JokerTypeData { DBName = "WEE JOKER", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.WeeJoker_UnlockId } },
            {"MERRY ANDY", new JokerTypeData { DBName = "MERRY ANDY", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.MerryAndy_UnlockId } },
            {"OOPS! ALL 6S", new JokerTypeData { DBName = "OOPS! ALL 6S", Price = 4, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.OopsAll6s_UnlockId } },
            {"THE IDOL", new JokerTypeData { DBName = "THE IDOL", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.TheIdol_UnlockId } },
            {"SEEING DOUBLE", new JokerTypeData { DBName = "SEEING DOUBLE", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.SeeingDouble_UnlockId } },
            {"MATADOR", new JokerTypeData { DBName = "MATADOR", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Matador_UnlockId } },
            {"HIT THE ROAD", new JokerTypeData { DBName = "HIT THE ROAD", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.HitTheRoad_UnlockId } },
            {"THE DUO", new JokerTypeData { DBName = "THE DUO", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Duo_UnlockId } },
            {"THE TRIO", new JokerTypeData { DBName = "THE TRIO", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Trio_UnlockId } },
            {"THE FAMILY", new JokerTypeData { DBName = "THE FAMILY", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Family_UnlockId } },
            {"THE ORDER", new JokerTypeData { DBName = "THE ORDER", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Order_UnlockId } },
            {"THE TRIBE", new JokerTypeData { DBName = "THE TRIBE", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Tribe_UnlockId } },
            {"STUNTMAN", new JokerTypeData { DBName = "STUNTMAN", Price = 7, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Stuntman_UnlockId } },
            {"INVISIBLE JOKER", new JokerTypeData { DBName = "INVISIBLE JOKER", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.InvisibleJoker_UnlockId } },
            {"BRAINSTORM", new JokerTypeData { DBName = "BRAINSTORM", Price = 10, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.Brainstorm_UnlockId } },
            {"SATELLITE", new JokerTypeData { DBName = "SATELLITE", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Satellite_UnlockId } },
            {"SHOOT THE MOON", new JokerTypeData { DBName = "SHOOT THE MOON", Price = 5, AchievementForUnlock = AchievementDb.ShootTheMoon_UnlockId } },
            {"DRIVER'S LICENSE", new JokerTypeData { DBName = "DRIVER'S LICENSE", Price = 7, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.DriversLicense_UnlockId } },
            {"CARTOMANCER", new JokerTypeData { DBName = "CARTOMANCER", Price = 6, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Cartomancer_UnlockId } },
            {"ASTRONOMER", new JokerTypeData { DBName = "ASTRONOMER", Price = 8, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Astronomer_UnlockId } },
            {"BURNT JOKER", new JokerTypeData { DBName = "BURNT JOKER", Price = 8, Rarity = JokerRarity.RARE, AchievementForUnlock = AchievementDb.BurntJoker_UnlockId } },
            {"BOOTSTRAPS", new JokerTypeData { DBName = "BOOTSTRAPS", Price = 7, Rarity = JokerRarity.UNCOMMON, AchievementForUnlock = AchievementDb.Bootstraps_UnlockId } },
